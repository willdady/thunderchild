...
urlpatterns = patterns('',
    ...
    (r'^backend/fields$', 'thunderchild.field_views.fields'),
    (r'^backend/fields/create$', 'thunderchild.field_views.create_fieldgroup'),
    (r'^backend/fields/edit/(\d+)$', 'thunderchild.field_views.edit_fieldgroup'),
    (r'^backend/fields/delete$', 'thunderchild.field_views.delete_fieldgroup'),
    (r'^backend/fields/(\d+)/create$', 'thunderchild.field_views.create_field'),
    (r'^backend/fields/(\d+)/edit/(\d+)$', 'thunderchild.field_views.edit_field'),
    (r'^backend/fields/(\d+)/delete$', 'thunderchild.field_views.delete_field'),
    
    (r'^backend/categories$', 'thunderchild.category_views.categories'),
    (r'^backend/categories/create$', 'thunderchild.category_views.create_categorygroup'),
    (r'^backend/categories/edit/(\d+)$', 'thunderchild.category_views.edit_categorygroup'),
    (r'^backend/categories/delete$', 'thunderchild.category_views.delete_categorygroup'),
    (r'^backend/categories/(\d+)/create$', 'thunderchild.category_views.create_category'),
    (r'^backend/categories/(\d+)/edit/(\d+)$', 'thunderchild.category_views.edit_category'),
    (r'^backend/categories/(\d+)/delete$', 'thunderchild.category_views.delete_category'),

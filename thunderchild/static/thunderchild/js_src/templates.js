...
(function() {
  ...
  GroupPaneView = Backbone.View.extend({
    ...
    initialize: function() {
      ...
      this.$el.find("ul li").each(function(i, el) {
        ...
        return _this.groups.push(groupItem);
      });
    ...
    selectedGroupItemChangeHandler: function() {
      var _this = this;
      return _.each(this.groups, function(item) {
        if (item !== _this.model.get("selectedGroupItem")) {
  ...
  TemplatePaneView = Backbone.View.extend({
    ...
    initialize: function() {
      ...
      this.templates = [];
      this.$el.find("ul li").each(function(i, el) {
        return _this.templates.push(new TemplateItemView({
          el: el,
          model: _this.model
        }));
      });

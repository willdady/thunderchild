...
class Template(models.Model):
    ...
    def asDict(self):
        # We purposely don't return template_uid as it's generated by combinging templategroup.templategroup_short_name and template_short_name.
        data = {
                'id':self.id,
    ...
    def is_redirected(self):
        if self.template_redirect_type == 302 or self.template_redirect_type == 301:
            return True
        return False
